    ...
    #define RK30SDK_WIFI_GPIO_RESET_ENABLE_VALUE    GPIO_HIGH    
            ...
            #define USE_SDMMC_CONTROLLER_FOR_WIFI 1
               ...
               // #define RK30SDK_WIFI_GPIO_BGF_INT_B_IOMUX_FMUX      GPIO3C_SDMMC1_DETECT_N
                ...
                //#define RK30SDK_WIFI_GPIO_VCCIO_WL_IOMUX_FMUX       GPIO0D_I2S2_2CH_LRCK_RX       
                //WIFI_INT_B
                #define RK30SDK_WIFI_GPIO_WIFI_INT_B                RK30_PIN4_PD7
                #define RK30SDK_WIFI_GPIO_WIFI_INT_B_ENABLE_VALUE   GPIO_HIGH 
                #define RK30SDK_WIFI_GPIO_WIFI_INT_B_PIN_NAME       GPIO4D7_SMCDATA15_TRACEDATA15_NAME
                #define RK30SDK_WIFI_GPIO_WIFI_INT_B_IOMUX_FGPIO    GPIO4D_GPIO4D7
                #define RK30SDK_WIFI_GPIO_WIFI_INT_B_IOMUX_FMUX     GPIO4D_GPIO4D7//GPIO3D_SDMMC1_INT_N
                //BGF_INT_B
                #define RK30SDK_WIFI_GPIO_BGF_INT_B                 RK30_PIN4_PC5
                #define RK30SDK_WIFI_GPIO_BGF_INT_B_ENABLE_VALUE    GPIO_HIGH 
                #define RK30SDK_WIFI_GPIO_BGF_INT_B_PIN_NAME        GPIO4C5_SMCDATA5_TRACEDATA5_NAME
                #define RK30SDK_WIFI_GPIO_BGF_INT_B_IOMUX_FGPIO     GPIO4C_GPIO4C5
                #define RK30SDK_WIFI_GPIO_BGF_INT_B_IOMUX_FMUX      GPIO4C_GPIO4C5
                //GPS_SYNC
                #define RK30SDK_WIFI_GPIO_GPS_SYNC                  RK30_PIN0_PA4
                #define RK30SDK_WIFI_GPIO_GPS_SYNC_ENABLE_VALUE     GPIO_HIGH 
                #define RK30SDK_WIFI_GPIO_GPS_SYNC_PIN_NAME         GPIO0A4_PWM1_NAME
                #define RK30SDK_WIFI_GPIO_GPS_SYNC_IOMUX_FGPIO      GPIO0A_GPIO0A4
                #define RK30SDK_WIFI_GPIO_GPS_SYNC_IOMUX_FMUX       GPIO0A_GPIO0A4
...
static void rk29_sdmmc_set_iomux_mmc0(unsigned int bus_width)
{
    switch (bus_width)
    {
    	...
    	break;
//add by wfy for suspend current inc to 40mA when sd card insert--------
	case 0x1234:
		...
		gpio_request(RK30_PIN3_PB0,"mmc_suspend_clk");
		gpio_direction_input(RK30_PIN3_PB0);
		gpio_request(RK30_PIN3_PB1,"mmc_suspend_cmd");
		gpio_direction_input(RK30_PIN3_PB1);
		gpio_request(RK30_PIN3_PB2,"mmc_suspend_d0");
		gpio_direction_input(RK30_PIN3_PB2);
		gpio_request(RK30_PIN3_PB3,"mmc_suspend_d1");
		gpio_direction_input(RK30_PIN3_PB3);
		gpio_request(RK30_PIN3_PB4,"mmc_suspend_d2");
		gpio_direction_input(RK30_PIN3_PB4);
		gpio_request(RK30_PIN3_PB5,"mmc_suspend_d3");
		gpio_direction_input(RK30_PIN3_PB5);
		break;
//----------------------------------------------------------------------
...
//miaozh add for wifi cause the null pointer crash	
int rk29sdk_wifi_reset(int on)
{    		
    if(on)
    {
        gpio_set_value(rk_platform_wifi_gpio.reset_n.io, rk_platform_wifi_gpio.reset_n.enable);     
        pr_info("rk29sdk_wifi_reset out 1\n");
    }
    else
    {
        gpio_set_value(rk_platform_wifi_gpio.reset_n.io, !(rk_platform_wifi_gpio.reset_n.enable) );        
        pr_info("rk29sdk_wifi_reset out 0\n");
    }
    mdelay(100);
    return 0;
}
