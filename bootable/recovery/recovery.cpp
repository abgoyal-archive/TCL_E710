...
static const struct option OPTIONS[] = {
  { "factory_mode", no_argument, NULL, 'f' },
...
//    printf("Test to run rest bin in recovery!!!\n");

    if(!check_sdboot()) {
    	printf("Enter check sdboot!\n");
    ...
    ui->Print("Rebooting...\n");
//miaozh modify for make recovery boot stay at charging state    
    //android_reboot(ANDROID_RB_RESTART, 0, 0);
   	 android_reboot(ANDROID_RB_RESTART2, 0, "charge");
    return EXIT_SUCCESS;
}
